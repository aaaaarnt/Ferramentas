...
dados     segment
asterisco db    '*$'
coresPrograma  db    0Fh ; fundo preto (1), texto em branco (7)
dados     ends
...
; como se fosse uma janela desde (0,0) at� (24,79)
rolartela:
...
; exemplo de instru��es para posicionar cursor      
          mov   dh,0        ; linha 0
          mov   dl,0        ; coluna 0
          call  poscursor   ; posiciona cursor na posicao (0,0) da tela

;  exemplo de instru��o para escrever um '*' na posicao em que esta o cursor
          call  asterisca   ; escreve um '*' nesta posicao

; substitua os exemplos acima por uma serie de instrucoes que "desenhe"
; com asteriscos na tela o seguinte (configure p�gina para paisagem):
;             1         2         3         4         5         6         7
...
espera_tecla proc ; espera at� uma tecla qualquer ser pressionada e retorna
